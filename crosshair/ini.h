...
public:
	...
	// Get a real (doubleing point double) value from INI file, returning
	// default_value if not found or not a valid doubleing point value
	// according to strtod().
